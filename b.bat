...
cmake ..\.. -GNinja -DCMAKE_BUILD_TYPE=Debug -DDSVEOSCOSIM_BUILD_TESTS=ON || exit /b 1
...
cmake ..\.. -GNinja -DCMAKE_BUILD_TYPE=Release -DDSVEOSCOSIM_BUILD_TESTS=ON -DDSVEOSCOSIM_BUILD_BENCHMARKS=ON || exit /b 1
