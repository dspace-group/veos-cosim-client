...
TEST_P(TestProtocol, SendAndReceiveConnect) {
    ...
    AssertOk(_protocol->ReadConnect(_receiverChannel->GetReader(),
                                   receiveVersion,
                                   receiveMode,
                                   receiveServerName,
                                   receiveClientName));
...
TEST_P(TestProtocol, SendAndReceiveStep) {
    ...
    SimulationTime receiveSimulationTime{};
    AssertOk(_protocol->ReadStep(_receiverChannel->GetReader(),
...
TEST_P(TestProtocol, SendAndReceiveStepOk) {
    ...
    // Act
    AssertOk(_protocol->SendStepOk(_senderChannel->GetWriter(),
                                  sendSimulationTime,
                                  sendCommand,
                                  serializeFunction,
                                  serializeFunction));
    ...
    SimulationTime receiveSimulationTime{};
    Command receiveCommand{};
    AssertOk(_protocol->ReadStepOk(_receiverChannel->GetReader(),
                                  receiveSimulationTime,
                                  receiveCommand,
                                  deserializeFunction,
                                  deserializeFunction,
