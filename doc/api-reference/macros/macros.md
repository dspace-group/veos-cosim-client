...
- [Macros](#macros)
  ...
  - [List of Macros and Constants](#list-of-macros-and-constants)
...
> [DSVEOSCOSIM_CAN_MESSAGE_MAX_LENGTH](DSVEOSCOSIM_CAN_MESSAGE_MAX_LENGTH.md)

Defines the maximum length of a CAN message payload.
...
Defines the maximum length of a FlexRay message payload.

> [DSVEOSCOSIM_LIN_MESSAGE_MAX_LENGTH](DSVEOSCOSIM_LIN_MESSAGE_MAX_LENGTH.md)

Defines the maximum length of a LIN message payload.
