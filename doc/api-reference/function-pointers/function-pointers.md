...
> [DsVeosCoSim_IncomingSignalChangedCallback](DsVeosCoSim_IncomingSignalChangedCallback.md)
...
> [DsVeosCoSim_LogCallback](DsVeosCoSim_LogCallback.md)

Called each time the VEOS CoSim client receives a log message.

> [DsVeosCoSim_SimulationCallback](DsVeosCoSim_SimulationCallback.md)

A generic simulation callback function pointer.

> [DsVeosCoSim_SimulationTerminatedCallback](DsVeosCoSim_SimulationTerminatedCallback.md)
